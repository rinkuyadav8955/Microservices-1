...
public class EmployeeService {
	...
	public EmployeeResponse getEmployeeById( Integer p_id ) {
		...
		AddressResponse l_addressResponse = getAddressResponseUsingRestTemplate( p_id );
	...
	private AddressResponse getAddressResponseUsingRestTemplate( Integer p_id ) {
		return restTemplate.getForObject( "http://127.0.0.1:8080/api/v1/address/{id}", AddressResponse.class, p_id );
